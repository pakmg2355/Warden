...
List<ComboDefinition> listadoCombos = [
  ...
  ComboDefinition(
    id: t('combo.dze.t3.id'),
    sequence: '3131',
    name: t('combo.dze.t3.name'),
    description: t('combo.dze.t3.desc'),
    powerCost: 10,
    tier: 3,
    type: EffectType.dazeStack,
    effects: [
      EfectoClass(
        nombre: t('combo.dze.t3.name'),
        tier: 3,
        target: EffectTarget.enemy,
        type: EffectType.dazeStack,
        daze: 15,
  ...
  ComboDefinition(
    id: t('combo.dze.t4.id'),
    sequence: '31313',
    name: t('combo.dze.t4.name'),
    description: t('combo.dze.t4.desc'),
    powerCost: 10,
    tier: 4,
    type: EffectType.dazeStack,
    effects: [
      EfectoClass(
        nombre: t('combo.dze.t4.name'),
        tier: 4,
        target: EffectTarget.enemy,
        type: EffectType.dazeStack,
        daze: 15,
